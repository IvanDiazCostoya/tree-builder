...
import print_node_info
import print_button_text
import tree
...
class UI(QMainWindow):
    def __init__(self):
        ...
        gui_file = os.path.join(gui_dir, 'gui.ui')
    ...
    def print_tree(self):
        ...
        img1 = os.path.join(directory, 'img/arrow_1.jpg')
        img2 = os.path.join(directory, 'img/arrow_2.jpg')
        img3 = os.path.join(directory, 'img/arrow_3.jpg')
        img4 = os.path.join(directory, 'img/arrow_4.jpg')
        img5 = os.path.join(directory, 'img/arrow_5.jpg')
